...
b = BookClub.create({name: 'clubseed2', description: 'We read and talk about the best books!', address:  address: {address_line1: '500 Kingston Rd', city: 'Toronto', province: 'Ontario', postal_code:'M4L 1V3', country: 'canada'}})
c = BookClub.create({name: 'clubseed3', description: 'We read and talk about the best books!', address:  address: {address_line1: '315 St Germain Ave', city: 'Toronto', province: 'Ontario', postal_code:'ON M5M 1W4', country: 'canada'}})
d = BookClub.create({name: 'clubseed4', description: 'We read and talk about the best books!', address:  address: {address_line1: '301 Front St W', city: 'Toronto', province: 'Ontario', postal_code:'M5V 2T6', country: 'canada'}})
